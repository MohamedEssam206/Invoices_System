...
@section('content')
				...
				<div class="row">
                    <div class="col-xl-12">
                        <div class="card mg-b-20"><br>
                            <div class="card-header pb-0">
                            {{--ده الي بيعرض button الأضافه --}}
                                @can('أضافة فاتورة')
                                    <a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                            class="fas fa-plus"></i>&nbsp; أضافة فاتورة</a>
                                @endcan
                                                            ...
                                                            <div class="dropdown-menu tx-13">
                                                                ...
                                                                @can('نقل الي الأرشيف')
                                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                                        ...
                                                                        <i class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp; نقل الي الأرشيف</a>
                                                                @endcan
...
@section('js')
    ...
    <script>
          // كود ال js الي بيظهرلي ال id لما باجي احذف
    ...
    <script>
        // كود ال js الي بيعمل archive للفاتورة
