...
@section('css')
{{-- الكود ده بيخفي كلمه print بيطبع الفاتوره من غيرها  --}}
    <style>
        @media print {
            #print_Button {
                display: none;
                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h4>FawaTer</h4>
                                <p> Egypt , Cairo , 21 St Maadi <br>
                                    Tel No: +20 106 428 6942<br>
                                    Email: mohammedessam2062000@gmail.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    <h6>Mostafa Elgazar</h6>
                                    <p>Egypt , Giza , 21 St Dokki<br>
                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                <thead>
                                <tr>
                                    <th class="wd-20p">رقم الفاتوره</th>
                                ...
                                <tr>
                                    ...
                                    <td class="tx-right" colspan="2"> {{ number_format($invoices->Discount) }}</td>
...
@endsection
    @section('js')
        ...
        <script type="text/javascript">
            {{-- الكود ده الي بيطبع ومش بيجيب الا معلومات الفاتوره بس  --}}
            function printDiv() {
