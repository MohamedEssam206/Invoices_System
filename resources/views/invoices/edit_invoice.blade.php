                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Amount_collection"
                                       ...
                                       required value="{{ $invoices->Amount_collection }}" >
...
@section('js')
    ...
    <script>
        {{-- ده كود التاريخ الخاص بي الوقت الي في الفورم فوق  --}}
    ...
    <script>
        $(document).ready(function() {
            // ده كود ال ajax الي بيظهر ليا المنتجات تلقائيا لما اجي اختار القسم
