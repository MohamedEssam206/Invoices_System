    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                ...
                <p class="mg-b-0">Mr : {{ auth()->user()->name }}</p>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
    ...
    <div class="row row-sm">
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-14 text-white">إجمالي مبلغ الفواتير</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h1 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format(\App\Models\Invoices::sum('total'))  }}
                                </h1>
                                <p class="tx-14 font-weight-bold mb-1 text-white">
                                    <a class="text-white" href="{{ url('/' . $page='invoices') }}">عدد الفواتير/
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-14 text-white">إجمالي مبلغ الفواتير المدفوعة</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <a class="text-white" href="{{ url('/' . $page='invoices_paid') }}">عدد الفواتير/
                                ...
                                <span class="text-white op-7 ">
                                    ...
                                    @php
                                        ...
                                        if ($count_invoices1 == 0){
                                            ...
                                            echo number_format($count_invoices2 = $count_invoices1 / $count_all *100) ;
                                        }
                                    @endphp%
                                </span>
                            </span>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h1 class="mb-3 tx-14 text-white">إجمالي مبلغ الفواتير المدفوعة جزئيا</h1>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <a class="text-white" href="{{ url('/' . $page='invoices_partial/{id}') }}">عدد الفواتير/
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        if ($count_invoices3 == 0){
                                            ...
                                            echo number_format($count_invoices2 = $count_invoices3 / $count_all *100) ;
                                        }
                                    @endphp%
                                </span>
                            </span>
        ...
        <div class=" col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-14 text-white">إجمالي مبلغ الفواتير الغير مدفوعة</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <a class="text-white" href="{{ url('/' . $page='invoices_unpaid') }}">عدد الفواتير/
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        if ($count_invoices2 == 0){
                                            ...
                                            echo number_format($count_invoices2 = $count_invoices2 / $count_all *100) ;
                                        }
                                    @endphp%
                                </span>
                            </span>
