...
@section('content')
    ...
    <div class="row">
                                        ...
                                        <td>
                                            ...
                                            @can('حذف قسم')
                                                <button class="btn btn-outline-danger btn-sm"
                                                    data-id="{{ $section->id }}"
                                                    data-section_name="{{ $section->section_name }}"
                                                    data-toggle="modal" href="#modaldemo9" >حذف </button>
                                            @endcan
                                        </td>
                                    </tr>
                                @endforeach
        ...
        <!--  -->
        <!-- ده كود ال store بعد ما بعمل Update-->
...
@section('js')
    ...
    <script src="{{URL::asset('assets/js/modal.js')}}"></script>
            ...
            <script>
                // ده الي بيرجع البيانات لما تيجي تعمل تعديل في الفورم
