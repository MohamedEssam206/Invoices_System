...
@section('content')
                ...
                <div class="col-xl-12">
                    <div class="card mg-b-20">
                        <div class="card-header pb-0">
                            ...
                            <!--  ده ال بيظهر button الأضافه -->
                            <div class="d-flex justify-content-between">
                                @can('أضافة منتج')
                                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#exampleModal8" >اضافة منتج</a>
                                @endcan
                            </div>
                        </div>
                ...
                <!-- add -->
                <!-- ده ال بيشغل button الأضافه وبيحدد انت عاوز انهي section-->
